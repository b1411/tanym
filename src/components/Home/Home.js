...
function Home() {
  ...
  function acceptApllication(e) {
    ...
    if (name && surname && email && phone && captcha) {
      const apllication = new Parse.Object("Entry");
  ...
  return loaded ? (
    <>
      ...
      <section className="section-regular non-visible">
            ...
            items={[
              ...
              >
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                      height={50}
                      src="https://i.imgur.com/OsBp3zb.png"
                      alt=""
                    /> */}
                    <h4>Bibigul Yeldosova</h4>
                  </div>
                  <p>
                    В профсоюзе Таным работают настоящие профессионалы своего
                    дела. 👏👏👏👏
                  </p>
                </div>
              </div>,
                ...
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                                  ...
                                  alt=""
                                /> */}
                    <h4>Hadisha Taraseva</h4>
                  </div>
                  <p>
                    Таным өте жақсы ұйым. Жұмыстарын тиянақты, жауапкершілікпен
                    атқарады. Тек алға 👏👏👏👍👍👍🔥🔥🔥
                  </p>
                </div>
              </div>,
                ...
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                                              ...
                                              alt=""
                                            /> */}
                    <h4>Aibanu Daurenova</h4>
                  </div>
                  <p>
                    Елеп-ескеріп кәсіби мерекемізде тосын сыйлық жасап қуаныш
                    сыцлағандарыңызға көп рахмет👏😍 Мәселе сыйлықта емес
                    көіңлде. Таным ұйымы -мықты💪
                  </p>
                </div>
              </div>,
              <div
              ...
              >
                <div className={"review"}>
                  ...
                  <p>
                    Мы очень рады что вступили в Таным. Хотим пожелать чтобы наш
                    профсоюз расширялся, процветал. И чтобы побольше вступали в
                    наши ряды сотрудники образования. 👏👏👏🔥🔥🔥
                  </p>
                </div>
              </div>,
              <div
                ...
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                                                          ...
                                                          alt=""
                                                        /> */}
                    <h4>Halima Bekbolateva</h4>
                  </div>
                  <p>
                    Спасибо вам большое Таным. За очень приятный сюрприз. За
                    ваше внимание. Так ещё нас никто не поздравлял.
                    👏👏👏👏🔥🔥🔥
                  </p>
                </div>
              </div>,
                ...
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                                                                      ...
                                                                      alt=""
                                                                    /> */}
                    <h4>Shakira Daureneva</h4>
                  </div>
                  <p>
                    Білім беру қызметкерлеріне қолдау білдіретіндеріңізге ,
                    сұрақтарына жауап беретіндеріңізге үлкен алғыс👏
                  </p>
                </div>
              </div>,
              <div
                ...
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                                                                                                ...
                                                                                                alt=""
                                                                                              /> */}
                    <h4>Aizada Akmetzhanova</h4>
                  </div>
                  <p>
                    😍🤭 Ребята, удачи Вам ! Благодаря вам многие мои знакомые
                    просто начали верить в чудо, а это в наше время ой как
                    нужно. Ведь чем больше позитива мы посылаем в Вселенную, она
                    возвращает ее в тысячи раз больше 🙌. Все благие дела
                    возвращаются бумерангом 🙌 . ВАШ профсоюз делает
                    действительно хорошее для самой благородной и в тоже время
                    не благодарной профессии учитель😢 Процветания вам. Пусть
                    ваш труд будет оценен Всевышним 🙌 достатка и гармонии во
                    всем вам ребята.
                  </p>
                </div>
              </div>,
                ...
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                                                                                                ...
                                                                                                alt=""
                                                                                              /> */}
                    <h4>Aigul Iliyasova</h4>
                  </div>
                  <p>
                    Осындай ұйымды көптен күттік десек артық емес. Әрине біз
                    жоғары білімді педагогтармыз, бірақ көп ретте заңдарды
                    білмегендіктен өз құқықтарымызды қорғай алмай жатамыз. Таным
                    кәсіподағы қысқа әрі нұсқа ең бастысы заңға сүйене отырып
                    нақты көмектерін беріп жатыр. Бұл өте қуанышты жайт.
                  </p>
                </div>
              </div>,
              <div
                ...
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                                                                                                ...
                                                                                                alt=""
                                                                                              /> */}
                    <h4>Aigerim Ershateva</h4>
                  </div>
                  <p>
                    Спасибо вам за труд! Впервые в жизни, учителя под защитой
                    профсоюза!
                  </p>
                </div>
              </div>,
                ...
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    {/* <img
                                                                                                                          ...
                                                                                                                          alt=""
                                                                                                                        /> */}
                    <h4>Hamida Rustemova</h4>
                  </div>
                  <p>Самое главное не пустые разговоры Говорят и делают 100%</p>
                </div>
              </div>,
              <div
                style={{
              ...
              >
                <div className={"review"}>
                  ...
                  <p>
                    TANYM всегда был здесь, чтобы помочь мне решить любые
                    проблемы, с которыми я сталкивался на работе. Я знаю, что
                    могу всегда на них рассчитывать.
                  </p>
                </div>
              </div>,
              <div
              ...
              >
                <div className={"review"}>
                  ...
                  <p>
                    TANYM - это невероятный профсоюз, который действительно
                    заботится о своих членах. Они постоянно ищут способы
                    улучшить нашу жизнь на работе и защитить наши интересы
                  </p>
                </div>
              </div>,
              <div
              ...
              >
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    <h4>Turlan Nursultanev</h4>
                  </div>
                  <p>
                    Отличный профсоюз TANYM! Я бы хотел выразить глубокую
                    благодарность всему коллективу за их постоянную заботу и
                    поддержку учителей. Они всегда готовы помочь и содействовать
                    решению любых вопросов, связанных с нашей работой. Я также
                    оцениваю их постоянные усилия по улучшению условий труда и
                    заработной платы учителей. Я уверен, что профсоюз TANYM
                    продолжит играть важную роль в защите прав и интересов
                    учителей.
                  </p>
                </div>
              </div>,
              ...
              >
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    <h4>Nurzhan Alenev</h4>
                  </div>
                  <p>
                    Я был впечатлен качеством услуг, которые предлагает TANYM.
                    Они всегда действуют в лучших интересах своих членов и
              ...
              >
                <div className={"review"}>
                  <div className={"tittle-review"}>
                    <h4>Zamzagul Aniyarova</h4>
                  </div>
                  <p>
                    Как учительница, я очень благодарна профсоюзу TANYM. Они
                    всегда готовы предоставить необходимую помощь и поддержку,
                    когда это необходимо. Я также оцениваю их постоянные усилия
                    по улучшению условий труда и жизни учителей. Благодаря
                    профсоюзу TANYM, я чувствую себя безопасной и защищенной в
                    своей работе.
                  </p>
                </div>
              </div>,
